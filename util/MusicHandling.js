...
function play(guild, song) {
    ...
    const dispatcher = queue.get(guild.id).connection.playStream(ytdl(song.url, { quality: "highestaudio", filter: "audioonly" }), { passes: 3, volume: queue.get(guild.id).volume || 1 })
    .on("end", () => {
